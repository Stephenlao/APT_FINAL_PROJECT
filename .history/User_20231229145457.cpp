...
void Member::updateCreditInFile(string userId, float newCreditPoint){
    ...
    while (std::getline(myFile, line))
    {
        ...
        if (temp_userID == userId_val)
        {
            ...
            std::string tempCreditPoint_str = std::to_string(floatValue);
            lines.push_back(temp_userID + "," + temp_password + "," + temp_username + "," + tempFullname + "," + tempEmail + "," + tempPhoneNumber + "," + tempHomeAddress + "," + tempCity + "," + tempCreditPoint_val + "," + restOfLine);
