...
void Member::updateCreditInFile(string userId, float newCreditPoint){
    ...
    {
        std::stringstream ss(line);
        std::string temp_userID, temp_password, temp_username, tempFullname, tempEmail, tempPhoneNumber, tempHomeAddress, tempCity, tempCre restOfLine;
        userID,Password,UserName,FullName,Email,PhoneNumber,HomeAddress,City,CreditPoint,SkillRating,IsListed
