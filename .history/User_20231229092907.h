...
// AvailableList class
    ...
    void createRequest(vector<Skill*>& skillRatingSupporter, string hostID, string supporterID);
    string getSkillNameByOrderNumber(vector<Skill*>& skillRatingSupporter)
    };
